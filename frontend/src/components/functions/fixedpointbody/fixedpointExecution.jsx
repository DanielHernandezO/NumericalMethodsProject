...
import FixedpointForm from "./fixedpointForm";
            ...
            <div className="card-body">
                ...
                <div className="row">
                    <div className="form-container">
                        <FixedpointForm run={run} clear={clear} dataForm={dataForm} handleChangeDataForm={handleChangeDataForm} />
                    </div>
                    <div className="col">
...
export default FixedpointExecution;