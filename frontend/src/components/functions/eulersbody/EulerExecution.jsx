...
import EulerForm from "./EulerForm";
import Logs from "../../logs";
import '../../../styles/functions.css';
const EulerExecution = ({run, clear, dataForm, handleChangeDataForm, logs}) => {
    return (
        ...
        <div className="card-body">
            ...
            <div className="row">
                <div className="form-container">
                    <EulerForm run={run} clear={clear} dataForm={dataForm} handleChangeDataForm={handleChangeDataForm}/>
                </div>
                <div className="col">
