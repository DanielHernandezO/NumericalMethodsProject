...
import PivotLuBodyDescription from "./pivotLuBodyDescription"
import PivotBodyExecution from "./pivotBodyExecution"
import PivotBodyResult from "./pivotBodyResult"
import validateMatrix from "../../../utilities/validateMatrix"
import validateVector from "../../../utilities/validateVector"
import partialLu from "../../../utilities/methods/functions/partialLu"
...
const PivotLuBody = () => {
    ...
    const run = () => {
        ...
        if(validateDataResult){
            ...
            const {x, stages, logs} = partialLu(matrixTransformered,vectorTransformered);
    ...
    useEffect(()=>{
        if(isRun){
            document.getElementById('result_pivot_lu').scrollIntoView()
        }
    },[isRun])
    ...
    return (
        <div className="container">
            <h1 className="text-center">Pivot LU</h1>
            <PivotLuBodyDescription />
            <PivotBodyExecution run={run} dataForm={dataForm} handleChangeDataForm={handleChangeDataForm} logs={logs} clear={clear}/>
            {isRun?<PivotBodyResult matrixList={matrixList} vectorResult={vectorResult}/>:null}
            <Graph />
        </div>
    )
}

export default PivotLuBody;