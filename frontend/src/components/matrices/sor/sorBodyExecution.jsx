...
const SorBodyExecution = ({ logs, run, dataForm, handleChangeDataForm, clear }) => {
    return (
            ...
            <div className="card-body">
                ...
                <div className="row">
                    <div className="form-container">
                        <SorForm run={run} dataForm={dataForm} handleChangeDataForm={handleChangeDataForm} clear={clear} />
                    </div>
                    <div className="col">
...
export default SorBodyExecution;