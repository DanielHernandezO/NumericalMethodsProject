...
const TridiagonalForm = ({dataForm,run,clear,handleChangeDataForm}) => {
    return (
        <form>
            <div>
                <div className="row mb-3">
                    <div className="col-sm-10">
                        <label><Latex>{'$A_{1xn}$'}</Latex></label>
                ...
                <div className="row mb-3">
                    <div className="col-sm-10">
                        <label><Latex>{'$c_{1xn}$'}</Latex></label>
                        <input type="text" className="form-control form-control-sm" id="c" placeholder="c" value={dataForm.c} onChange={handleChangeDataForm} />
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-10">
                        <label><Latex>{'$d_{1xn}$'}</Latex></label>
                        <input type="text" className="form-control form-control-sm" id="d" placeholder="d" value={dataForm.d} onChange={handleChangeDataForm} />
                    </div>
                </div>
            </div>
            <div>
...
export default TridiagonalForm;