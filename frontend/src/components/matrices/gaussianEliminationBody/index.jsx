...
import gaussianElimination from "../../../utilities/methods/functions/gaussianElimination"
...
const SimpleLuBody = () => {
    ...
    return (
        <div className="container">
            <h1 className="text-center">Gaussian Elimination</h1>
            <GaussianEliminationBodyDescription />
            <GaussianEliminationExecution run={run} dataForm={dataForm} handleChangeDataForm={handleChangeDataForm} logs={logs} clear={clear}/>
            {isRun?<GaussianEliminationBodyResult matrixList={matrixList} vectorResult={vectorResult}/>:null}
            <Graph />
        </div>
    )
}
